...
<html>
    <%
       ...
       CategorieDAO cdao=new CategorieDAO();
        ...
        Image img=daoi.findById(film.getImage());
		...
		<div class="container">
			<div class="agileinfo_single">
				...
				<div class="col-md-4 agileinfo_single_left">
					<img id="example" src="../assets/images/imagefilm/<%out.println(cat.getType());%>/<%=img.getImage2()%>" alt=" " class="img-responsive" Style="width: 300px;height: 300px">
				</div>
				...
				<h2><%=film.getTitre()%></h2>
						...
						<span class="starRating">
							...
							<label for="rating1">1</label>
                                ...
                                <div class="w3agile_description">
                                    <h4>Release date :   <span class="m-sing"><%=new Tools().formatDateToString(film.getDatesortie())%></span></h4>
                                   
						<p>Duration : <%=film.getDuration()%></p>  
                                </div>
					<div class="w3agile_description">
						<h4>Synopsis :</h4>
					...
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4 class="m-sing">Price  : $<%=film.getPrix()%> </h4>
						</div>
						<div class="snipcart-details agileinfo_single_right_details">
							<form action="play.jsp" method="post">
								<fieldset>
									...
									<input type="submit" name="submit" value="subscriber" class="button">
								</fieldset>
							</form>
						</div>
					</div>
